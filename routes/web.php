...
route::middleware('isLogin')-> group(function(){
    ...
    //path yang ada {} artinya path dinamis. path dinamis merupakan path yang datanya diisi dari data base. path dinamis ini nantinya
    //akan berubah berubah tergantung data yang diberikan . apabila dalam routenya ada path dinamis maka nantinya
    //data path dinamis ini dapat diakses oleh controller melalui parameter di functionya.

    //dalam satu route boleh lebih dari satu path dinamis
 
    Route::get('/edit/{id}',[TodoController::class,'edit'])->name('edit');
    // method route buat update ke database itu pake patch/put
